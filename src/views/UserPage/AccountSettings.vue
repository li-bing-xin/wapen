<template>
    ...
    <v-btn size="small" class="ml-3" variant="text"
      ...
      <v-dialog width="500" v-model="usernameDialog" activator="parent">
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn variant="text" @click="onCancelUpdateName"> Cancel </v-btn>
            <v-btn color="primary" type="submit" @click="onUpdateName"
              >Update
            </v-btn>
          </v-card-actions>
        </v-card>
  ...
  <div class="about-user">
    <div class="my-3">
      Understanding how you use Grammarly helps us develop features tailored to
      your writing needs.
    </div>
    ...
    <div class="my-3">
      Understanding your writing outcome goals when writing at work helps us
      develop features tailored to your writing needs.
    </div>
